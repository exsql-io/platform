...
var file_substrait_function_proto_rawDesc = []byte{
	...
	0x0d, 0x61, 0x72, 0x67, 0x75, 0x6d, 0x65, 0x6e, 0x74, 0x5f, 0x6b, 0x69, 0x6e, 0x64, 0x42, 0x98,
	...
	0x01, 0x5a, 0x34, 0x67, 0x69, 0x74, 0x68, 0x75, 0x62, 0x2e, 0x63, 0x6f, 0x6d, 0x2f, 0x65, 0x78,
...
func file_substrait_function_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_substrait_function_proto_msgTypes[0].Exporter = func(v any, i int) any {
		...
		file_substrait_function_proto_msgTypes[1].Exporter = func(v any, i int) any {
		...
		file_substrait_function_proto_msgTypes[2].Exporter = func(v any, i int) any {
		...
		file_substrait_function_proto_msgTypes[3].Exporter = func(v any, i int) any {
		...
		file_substrait_function_proto_msgTypes[4].Exporter = func(v any, i int) any {
		...
		file_substrait_function_proto_msgTypes[5].Exporter = func(v any, i int) any {
		...
		file_substrait_function_proto_msgTypes[6].Exporter = func(v any, i int) any {
		...
		file_substrait_function_proto_msgTypes[7].Exporter = func(v any, i int) any {
		...
		file_substrait_function_proto_msgTypes[8].Exporter = func(v any, i int) any {
		...
		file_substrait_function_proto_msgTypes[9].Exporter = func(v any, i int) any {
		...
		file_substrait_function_proto_msgTypes[10].Exporter = func(v any, i int) any {
		...
		file_substrait_function_proto_msgTypes[11].Exporter = func(v any, i int) any {
