...
var file_substrait_extended_expression_proto_rawDesc = []byte{
	...
	0x65, 0x55, 0x72, 0x6c, 0x73, 0x42, 0xa2, 0x01, 0x0a, 0x0d, 0x63, 0x6f, 0x6d, 0x2e, 0x73, 0x75,
...
func file_substrait_extended_expression_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_substrait_extended_expression_proto_msgTypes[0].Exporter = func(v any, i int) any {
		...
		file_substrait_extended_expression_proto_msgTypes[1].Exporter = func(v any, i int) any {
