...
var file_substrait_capabilities_proto_rawDesc = []byte{
	...
	0x74, 0x69, 0x6f, 0x6e, 0x4b, 0x65, 0x79, 0x73, 0x42, 0x9c, 0x01, 0x0a, 0x0d, 0x63, 0x6f, 0x6d,
...
func file_substrait_capabilities_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_substrait_capabilities_proto_msgTypes[0].Exporter = func(v any, i int) any {
		...
		file_substrait_capabilities_proto_msgTypes[1].Exporter = func(v any, i int) any {
