...
var file_substrait_plan_proto_rawDesc = []byte{
	...
	0x63, 0x65, 0x72, 0x42, 0x94, 0x01, 0x0a, 0x0d, 0x63, 0x6f, 0x6d, 0x2e, 0x73, 0x75, 0x62, 0x73,
...
func file_substrait_plan_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_substrait_plan_proto_msgTypes[0].Exporter = func(v any, i int) any {
		...
		file_substrait_plan_proto_msgTypes[1].Exporter = func(v any, i int) any {
			switch v := v.(*Plan); i {
			case 0:
				return &v.state
			case 1:
		...
		file_substrait_plan_proto_msgTypes[2].Exporter = func(v any, i int) any {
		...
		file_substrait_plan_proto_msgTypes[3].Exporter = func(v any, i int) any {
